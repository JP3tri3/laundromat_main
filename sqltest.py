...
# mycursor.execute("CREATE TABLE trade_values (id VARCHAR(16), symbol VARCHAR(16), symbol_pair VARCHAR(16), key_input INT UNSIGNED, limit_price_difference INT UNSIGNED, leverage INT UNSIGNED, input_quantity INT UNSIGNED, data_name VARCHAR(16)")
...
mycursor.execute("INSERT INTO trades () VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", ("main", '', '', 0, 0.0, 0, 0, ''))
db.commit()
...
def updateTableValue(id_name, column_name, value):
    try:
