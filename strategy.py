...
class Strategy:
    ...
    def __init__(self, trade_id, strat_id, vwap_margin_neg_input, vwap_margin_pos_input, input_quantity):
                ...
                if ((new_trend == 'cross_up') and (last_candle_wt1 < 5) and (last_candle_wt2 < 5)) or (new_trend == 'cross_down') and (last_candle_wt1 > -5) and (last_candle_wt2 > -5):
                    ...
                    while (flag == True):
                        ...
                        if (counter == tempTime):
                            ...
                            print("Percent Gained: " + str(self.calc.calc_percent_gained()))
                            print("")

                        elif(counter == tempTime/6):
                                print("Percent Gained: " +
                                            str(self.calc.calc_percent_gained()))
